    ...
    <div className="min-h-screen bg-light text-dark flex flex-col">
      ...
      <section className="pt-32 pb-16 bg-dark text-light">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display mb-6 text-center">[ˈɪ]mpro</h1>
          <p className="text-3xl font-display text-center text-mist">Improtheater</p>
        </div>
      </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-6">
                Hier stellen wir bald unser Improtheater vor.
              </p>
              <p className="text-lg mb-12">
                Diese Seite befindet sich derzeit im Aufbau. Schauen Sie bald wieder vorbei,
                um mehr über unsere Impro-Arbeit bei Zw[i:]g[ə]spräch e.V. zu erfahren.
              </p>
